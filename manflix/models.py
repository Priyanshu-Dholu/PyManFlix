...
class Movies(db.Model):
    ...
    def __repr__(self) -> str:
        return f"movies('{self.title}','{self.link}',{self.quality}','{self.dolby_audio}','{self.dual_audio},{self.poster_link},{self.movie_id_tmd}','{self.movie_backdrop_link}','{self.trailer_link}')"